    ...
    <div className="grid gap-3 md:grid-cols-2">
      ...
      >
        <Label title="Кинотеатр">
          <Input placeholder="Название кинотеатра" {...register('cinemaName')} />
        </Label>
        <Label title="ID менеджера кинотетра">
          <Input placeholder="ID менеджера кинотетра" {...register('managerId')} />
        </Label>
        <Label title="Адрес">
          <TextArea placeholder="Адрес" {...register('address.address')} />
        </Label>
        <Label title="Координаты">
          <ShowLocation />
        </Label>
        <AddScreens />
  ...
  return (
    <div>
      ...
      <div>
        ...
        >
          <Plus className="w-4 h-4" /> Добавить экран
        </Button>
      </div>
    </div>
  )
